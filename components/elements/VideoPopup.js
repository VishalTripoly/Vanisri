...
export default function VideoPopup({ style, text }) {
    ...
    return (
        <>
            ...
            {!style &&
                <a onClick={() => setOpen(true)} className="overlay-link lightbox-image video-fancybox ripple"><span className="fas fa-play" />
                </a>
            ...
            {style === 1 &&
                <div className="video-btn">
                    <a onClick={() => setOpen(true)} className="overlay-link lightbox-image video-fancybox ripple"><span className="fas fa-play" /> </a>
                </div>
            }
            {style === 2 &&
                <div className="video-btn">
                    <a onClick={() => setOpen(true)} className="overlay-link lightbox-image video-fancybox ripple"><span className="fas fa-play" /></a><h6>{text ? text : "Latest Program Video"}</h6>
                </div>
            }
            {style === 3 &&
                <div className="video-btn">
